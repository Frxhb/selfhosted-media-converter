...
function handleWsMessage(event) {
  ...
  if (data.type === "job_created" || data.type === "job_updated") {
    ...
    if (j) {
      ...
      j.eta = data.eta;
      if (data.current_item_title !== undefined) j.current_item_title = data.current_item_title;
      if (data.playlist_index !== undefined) j.playlist_index = data.playlist_index;
      if (data.playlist_count !== undefined) j.playlist_count = data.playlist_count;
      if (data.log_line) {
        if (!j.logs) j.logs = [];
